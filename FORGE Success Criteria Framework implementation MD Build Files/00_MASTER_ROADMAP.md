...
| Asset | Location |
|-------|----------|
| **Codebase** | GitHub: `Jtapias92672/OneDrive_1_1-19-2026-2` |
| **Build Status** | `Forge Build Set Up Files.../FORGE-BUILD-STATUS.md` |
| **Epic Tasks** | `Forge Build Set Up Files.../MASTER-TASKS.md` |
| **True Ralph System** | `Forge Build Set Up Files.../TRUE-RALPH-SYSTEM.md` |
| **Pipeline Code** | `forge-complete-pipeline/` directory |

> **Rule:** When documentation conflicts with source code, source code wins.

> ⚠️ **Code Snippets:** TypeScript examples in framework documents illustrate architectural patterns. For actual implementation, reference the source code in the GitHub repository.
...
| Human Review | `governance-gateway/gates` | Human-in-the-loop gates | 13 |
...
| 13_TOKEN_GUARDRAILS.md | True Ralph Loop constraints | ✅ Updated |
...
> **For Dev Team:** Use this table to find the actual code location for each document's concepts.

| Document | Primary Package(s) | Verified Location in Repo |
|----------|-------------------|---------------------------|
| 01_ANSWER_CONTRACT | answer-contract | `forge-complete-pipeline/answer-contract/` |
| 02_STRUCTURAL_VALIDATION | convergence-engine | `forge-complete-pipeline/convergence-engine/` |
| 03_SEMANTIC_VALIDATION | validators/computational | `forge-complete-pipeline/validators/computational/` |
| 04_QUALITATIVE_VALIDATION | convergence-engine | `forge-complete-pipeline/convergence-engine/` |
| 05_CONVERGENCE_ENGINE | forge-c, convergence-engine | `forge-complete-pipeline/forge-c/` + `convergence-engine/` |
| 06_EVIDENCE_PACK | evidence-packs | `forge-complete-pipeline/evidence-packs/` |
| 07_RULE_SYSTEM | governance-gateway | `forge-complete-pipeline/governance-gateway/policy/` |
| 08_RUBRIC_LIBRARY | answer-contract | `forge-complete-pipeline/answer-contract/templates/` |
| 09_DATA_PROTECTION | mcp-gateway | `forge-complete-pipeline/mcp-gateway/` (privacy components) |
| 10_ORCHESTRATION | mcp-gateway, forge-c | `forge-complete-pipeline/mcp-gateway/` + `forge-c/` |
| 11_OBSERVABILITY | infrastructure | Infrastructure/Terraform (outside forge-complete-pipeline) |
| 12_HUMAN_REVIEW | governance-gateway | `forge-complete-pipeline/governance-gateway/gates/` |
| 13_TOKEN_GUARDRAILS | N/A (process doc) | Enforced via `agent-bootstrap.sh` |
