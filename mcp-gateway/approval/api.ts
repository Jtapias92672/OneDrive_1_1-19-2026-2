...
import { ApprovalInfo, CARSAssessment, RequestContext } from '../core/types.js';
 ...
 * import { ApprovalGate } from './index.js';
 * import { createApprovalMiddleware } from './api.js';
 *
 * const app = express();
 * const gate = new ApprovalGate(config);
 *
 ...
 * ```typescript
 * import { ApprovalGate } from './index.js';
 * import { createApprovalServer } from './api.js';
 *
 * const gate = new ApprovalGate(config);
