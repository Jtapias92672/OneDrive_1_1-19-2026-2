...
export class ComponentBuilder {
   ...
   */
  buildJSX(frame: ParsedFrame, styles: GeneratedStyles, config: ReactGeneratorConfig): string {
    this.indentLevel = 0;
  ...
  private buildChildren(frame: ParsedFrame, parentStyles: GeneratedStyles): string {
...
${indent}</${element}>`;
  ...
  private extractInstanceProps(frame: ParsedFrame): Record<string, string> {
