...
│  AGENT      │    │  AGENT          │    │  AGENT      │
│             │    │                 │    │             │
│  Produces   │    │  - Structural   │    │  Converts   │
│  candidate  │    │  - Semantic     │    │  failures   │
│  output     │    │  - Qualitative  │    │  into       │
│             │    │    (LLM-Judge)  │    │  repair     │
│             │    │                 │    │  prompts    │
└─────────────┘    └─────────────────┘    └─────────────┘
```

### 6.2 Parallel Validation Pattern
...
### 6.3 Critic-Refiner Pattern (Maker-Checker)
...
1. **Anthropic Claude Code** - CLAUDE.md pattern for persistent rules
2. **LangSmith** - Evaluation and tracing patterns
3. **Guardrails AI** - Validation hub architecture
4. **Monte Carlo** - LLM-as-Judge best practices
